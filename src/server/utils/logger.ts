...
export class Logger {
  ...
  private formatMetadata(metadata?: LogMetadata): Record<string, unknown> | undefined {
  ...
  private formatMessage(level: LogLevel, message: string, metadata?: LogMetadata): string {
    ...
    const formattedMetadata = metadata ? ` ${JSON.stringify(this.formatMetadata(metadata))}` : '';
